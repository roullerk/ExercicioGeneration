...
public class ProjetoTeste {
	...
	public ProjetoTeste(int numero, String cpf,String nome, boolean ativa) {
		numero = gerador.nextInt(2000);
		this.cpf = cpf;
		this.ativa = ativa;
		this.nome = nome;
